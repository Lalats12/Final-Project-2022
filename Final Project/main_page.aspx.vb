...
Public Class WebForm1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim checkCurrDaySql As String = "SELECT booking_id"
    ...
    Protected Sub cal_venue_SelectionChanged(sender As Object, e As EventArgs) Handles cal_venue.SelectionChanged
